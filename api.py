...
skill_patterns = re.compile(r"\b(html|css|javascript|pandas|numpy|sickit learn|typescript|java|python|kotlin|flutter|react|angular|node|swift|ruby|php|c\+\+|c#|go|docker|kubernetes|aws|azure|gcp|graphql|ai|ml|dl|cv|nlp|devops|agile|ci/cd|sql|nosql|mongodb|firebase|redux|git|jira|confluence|trello|scrum|big data|data science|machine learning|deep learning|nlp|cloud computing|containerization|mvc|mvvm|mvp|.net|spring|django|express|flask|ios|dart|objective-c|cybersecurity|penetration testing|firewalls|siem|data analysis|pandas|numpy|matplotlib|seaborn|scikit-learn|tensorflow|keras|pytorch)\b", re.IGNORECASE)
